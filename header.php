...
<head id="<?php echo of_get_option('meta_headid'); ?>" data-template-set="html5-reset-wordpress-theme">
	...
	<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/materialize.min.css">
		<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/js/jquery.fullPage.css" />

	<?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
  <a href="#modal1" class="btn-floating btn-large waves-effect waves-light orange lighten-2 right modal-trigger"><i class="material-icons">&#xE0D0;</i>Contactez nous</a>
	<div id="entetseo" class="orange darken-2 ym-wrapper navbar-fixed">
		<div id="entetsiteweb" class="ym-wbox">
			<div id="santi" class="ym-grid linearize-level-1">
				<div class="ym-g33 ym-gl">
					<a id="logo" ref="<?php the_permalink(); ?>"><p class="white-text"><i class="fa fa-wordpress"></i>ordpress <span>Côte d'Ivoire</span></p></a>
				</div>
